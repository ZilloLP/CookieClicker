...
public class PremiumShopInventoryListener extends InventoryListener {
    private final LanguageConfig languageConfig;

    public PremiumShopInventoryListener(CookieClicker plugin, InventoryManager inventoryManager, InventoryType inventoryType) {
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        for (Map.Entry<Price, PremiumPrice> priceEntry : plugin.getPriceManager().getPremiumPrices().entrySet()) {
            ...
            if (clickedSlot != premiumPrice.getSlot() || type != premiumPrice.getType()) {
                continue;
            }
            ...
            playerProfile.addPerClick(premiumPrice.getAddClick());
            ...
            if (plugin.getStatsWallManager().getRankType().equalsIgnoreCase("perclick")) {
                ...
                timeStatsWall.addCachedData(playerProfile.getName(), premiumPrice.getAddClick());
            }
